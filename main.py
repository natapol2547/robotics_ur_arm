...
def main():
    with Robot(robot_ip=ROBOT_IP, grip_force=50) as robot:
        ...
        pid_x = pid.PID(0.0009375, 0.00001, 0.00001)
        pid_y = pid.PID(0.0009375, 0.00001, 0.00001)
        ...
        while True:
            ...
            block = cam.get_block_pos(np.array([134, 141, 101]), np.array([183, 255, 240]), 1000)
            ...
            if block is not None:
                ...
                print(f"Computed offsets: off_x={off_x}, off_y={off_y}")
